...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Length(
        min: 2,
        max: 60,
        minMessage: 'Votre prénom doit comporter un minimum de {{ limit }} caractères.',
    ...
    #[Assert\Length(
        min: 2,
        max: 60,
        minMessage: 'Votre nom doit comporter un minimum de {{ limit }} caractères.',
    ...
    #[Assert\Length(
        min: 2,
        max: 60,
        minMessage: 'Votre pseudo doit comporter un minimum de {{ limit }} caractères.',
